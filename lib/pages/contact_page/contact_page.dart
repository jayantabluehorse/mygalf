...
class _ContactPageState extends State<ContactPage> {
  final xController = Get.put(ContactController());
  ...
  Widget _formDetailsUpperSection({required context, required currentScreen}) {
    return UnconstrainedBox(
      child: Container(
        child: SizedBox(
          child: Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              InkWell(
                                ...
                                child: const ImageIcon(
                                  AssetImage(
                                      "assets/images/contact_twiter.png"),
                                  size: 50.0,
                                  color: Color(0xFF00578F),
                                ),
                              ),
                              ...
                              InkWell(
                                ...
                                child: const ImageIcon(
                                  AssetImage(
                                      "assets/images/contact_linkdin.png"),
                                  size: 50.0,
                                  color: Color(0xFF00578F),
                                ),
                              ),
